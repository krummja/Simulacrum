...
function(compile_shaders_v2 TARGET_NAME)
    find_program(GLSLC
        NAMES glslc
        HINTS ENV VULKAN_SDK
        PATH_SUFFIXES bin
    ...
    if(NOT GLSLC)
        message(FATAL_ERROR "glslc not found. Install glslc package or Vulkan SDK.")
    endif()
    ...
    foreach(SHADER_SOURCE ${SHADER_SOURCES})
        ...
        if(${SHADER_NAME} MATCHES "^[a-z]*.vert.glsl")
            message(STATUS "Found vertex shader ${SHADER_NAME}")
            set(SHADER_TYPE "vert")
        endif()

        if(${SHADER_NAME} MATCHES "^[a-z]*.frag.glsl")
        ...
        # GLSL -> SPV
        execute_process(
            COMMAND ${GLSLC} -fshader-stage=${SHADER_TYPE} ${SHADER_SOURCE} -o ${SHADER_SPV}
        )
